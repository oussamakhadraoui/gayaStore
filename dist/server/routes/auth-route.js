...
var CredentialsType_1 = require("../../lib/Validation/CredentialsType");
var trpc_1 = require("../trpc");
var getPayloadClient_1 = require("../../lib/getPayloadClient");
var server_1 = require("@trpc/server");
var zod_1 = require("zod");
exports.authRoute = (0, trpc_1.router)({
    createPayloadUser: trpc_1.publicProcedure
        .input(CredentialsType_1.CredentialsType)
    ...
    signIn: trpc_1.publicProcedure
        ...
        var input = _a.input, ctx = _a.ctx;
        return __awaiter(void 0, void 0, void 0, function () {
            var password, email, payload, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:

...
exports.Products = {
    ...
    hooks: {
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createProduct, update, data, updatedProduct, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            update = __assign(__assign({}, data), { priceId: createProduct.default_price, stripeId: createProduct.id });
    ...
    fields: [
        ...
        },
        {
            ...
            label: 'Category',
            type: 'select',
            options: index_1.PRODUCT_GAT.map(function (_a) {

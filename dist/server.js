    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                app.post('/api/webhooks/stripe', webHookMiddleware, webHookk_1.stripewebhookHandler);
            ...
            case 1:
                ...
                next_utils_1.nextAPP.prepare().then(function () {
                    ...
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            payload.logger.info("NEXT APP URL:".concat(process.env.NEXT_PUBLIC_SERVER_URL));
                            return [2 /*return*/];
                        });
                    }); });
                });
